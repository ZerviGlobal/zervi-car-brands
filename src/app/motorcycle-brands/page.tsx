...
export const metadata = {
  ...
  description: "Explore motorcycle manufacturer logos and brand stories.",
};

export default function motorcycle_brandsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-20 text-center sm:px-6">
      ...
      <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
        Explore motorcycle manufacturer logos and brand stories.
      </p>
